...
export const UserModal: React.FC<UserModalProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    lastName: '',
    email: '',
    role: 'client' as User['role'], // ✅ Valeur par défaut mise à jour
    ...
    if (isOpen) {
      if (user) {
        setFormData({
          ...
          email: user.email || '',
          role: user.role || 'client', // ✅ Mis à jour
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              <option value="client">Client</option>       {/* ✅ Mis à jour */}
              <option value="technicien">Technicien</option> {/* ✅ Mis à jour */}
              <option value="admin">Administrateur</option>  {/* ✅ Mis à jour */}
            </select>
          </div>
